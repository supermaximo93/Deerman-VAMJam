window.canSeePlayerFunction = function(ignoreSneaking) {
  ...
  if (player.sneaking || ignoreSneaking) {
...
GameScreen = ig.Game.extend({
	...
	INITIAL_STALL_TIME: 2,
	PAN_TIME: 3,
	GIRL_MUSIC_RANGE_SQUARED: 1000000,
...
ig.main('#canvas', TitleScreen, 60, 1280, 800, 1);
